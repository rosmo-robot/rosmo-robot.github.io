...
| ------------------------- | ----------------------------------------- | -------- |
| ~$12  Rosmo Chassis v0.7 with on-board motor driver | [Custom PCB Chassis](https://easyeda.com/editor#id=b5abe81a8cf94eb084f82a7bd405d07d){:target="_blank"} for sale soon, or you can order from JLPCB if you're brave     | 1       |
