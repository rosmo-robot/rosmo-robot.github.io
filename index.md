...
| ------------------------- | ----------------------------------------- | -------- |
| ~$12  Rosmo Chassis v0.7 with on-board motor driver | [Custom PCB Chassis](https://easyeda.com/editor#id=854beecbed1a4fc08648e359695dcf52){:target="_blank"} for sale soon, or [source](https://github.com/rosmo-robot/rosmo)    | 1       |
